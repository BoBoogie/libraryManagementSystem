<template>
  <div class="addStudent">
    <main-top-bar classify="添加用户"></main-top-bar>
    <div class="formBox">
        ...
        <el-form-item label="入学时间">
          <el-col :span="11">
            <el-form-item prop="schooldate">
              <el-date-picker type="date" placeholder="选择日期" v-model="ruleForm.schooldate"
    ...
    return {
      ...
      rules: {
        ...
        account: [
          ...
          { pattern: /^\d{13}$/, message: '学号为13位数字', trigger: 'change' }
        ],
        password: [
