...
CREATE TABLE `books`  (
  ...
  `booklocation` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- Records of books
-- ----------------------------
INSERT INTO `books` VALUES (1, 'javaScript高级程序设计', '李松锋', '人民邮电出版社', '1楼A架1层1号', 'A001-1', '1.jpg', '1629626378110', '1647770378110', 38, 1, '99.00', '软件类');
INSERT INTO `books` VALUES (2, '数据科学入门', '岳冰', '中国工信出版集团', '1楼A架4层8号', 'A002-2', '2.jpg', '1629626388520', '1632218388520', 38, 1, '30.99', '软件类');
INSERT INTO `books` VALUES (3, '项目管理新思维', '金从军', '人民邮电出版社', '1楼B架1层3号', 'B001-3', '3.jpg', '1629626403878', '1632218403878', 38, 1, '20.00', '管理类');
INSERT INTO `books` VALUES (4, '精益数据分析', '韩知白', '人民邮电出版社', '1楼A架3层6号', 'A003-4', '4.jpg', '1629626419240', '1632218419240', 39, 1, '25.00', '软件类');
INSERT INTO `books` VALUES (5, '你不知道的50个脑科学知识', '荊妍', '人民邮电出版社', '2楼C架1层5号', 'C001-5', '5.jpg', '1629626447511', '1632218447511', 39, 1, '40.50', '生物类');
INSERT INTO `books` VALUES (6, '证明达尔文', '陈鹏', '人民邮电出版社', '2楼D架3层7号', 'D001-6', '6.jpg', '1629626435554', '1632218435554', 39, 1, '70.00', '生物类');
INSERT INTO `books` VALUES (7, '信息流广告入门', '李明', '中国工信出版集团', '1楼B架5层7号', 'B002-7', '7.jpg', '1629628274949', '1632220274949', 40, 1, '50.33', '管理类');
INSERT INTO `books` VALUES (8, '精益品牌塑造', '谢婷婷', '中国工信出版集团', '1楼B架3层13号', 'B003-8', '8.jpg', '1629628518587', '1632220518587', 41, 1, '68.00', '管理类');
INSERT INTO `books` VALUES (9, '决策知识自动化', '王飞燕', '工业出版社', '1楼B架4层14号', 'B004-9', '9.jpg', '1629628553624', '1632220553624', 41, 1, '44.00', '管理类');
INSERT INTO `books` VALUES (10, '简单高校LATEX', '吴康隆', '人民邮电出版社', '1楼B架2层10号', 'B005-10', '10.jpg', NULL, NULL, NULL, 0, '62.00', '管理类');
INSERT INTO `books` VALUES (11, 'C语言程序设计现代方法', '吕修锋', '人民邮电出版社', '1楼A架1层10号', 'A004-11', '11.jpg', NULL, NULL, NULL, 0, '55.00', '软件类');
INSERT INTO `books` VALUES (12, '超供电电压的电路设计', '吴顺珉', '工业出版社', '3楼E架6层15号', 'E001-12', '12.jpg', NULL, NULL, NULL, 0, '44.00', '硬件类');
INSERT INTO `books` VALUES (13, '数据驱动力企业分析实战', '张奎', '人民邮电出版社', '1楼B架3层16号', 'B006-13', '13.jpg', NULL, NULL, NULL, 0, '22.69', '管理类');
INSERT INTO `books` VALUES (14, '简明的TensorFlow2', '李双锋', '人民邮电出版社', '1楼A架2层6号', 'A005-14', '14.jpg', NULL, NULL, NULL, 0, '70.52', '软件类');
INSERT INTO `books` VALUES (15, '面向对象是怎样工作的', '平泽章', '中国工信出版集团', '1楼A架5层9号', 'A006-15', '15.jpg', NULL, NULL, NULL, 0, '80.00', '软件类');
INSERT INTO `books` VALUES (16, '深入java虚拟机的算法与实现', '中村成洋', '人民邮电出版社', '1楼A架5层19号', 'A007-16', '16.jpg', NULL, NULL, NULL, 0, '19.99', '软件类');
INSERT INTO `books` VALUES (17, '图解人工智能', '多田智史', '人民邮电出版社', '1楼A架3层17号', 'A008-17', '17.jpg', NULL, NULL, NULL, 0, '46.50', '软件类');
INSERT INTO `books` VALUES (18, '微积分入门', '小平邦彦', '人民邮电出版社', '3楼F架4层18号', 'F001-18', '18.jpg', NULL, NULL, NULL, 0, '78.55', '数学类');
INSERT INTO `books` VALUES (19, '概率论及其应用', '郑元碌', '人民邮电出版社', '3楼F架2层12号', 'F002-19', '19.jpg', NULL, NULL, NULL, 0, '46.32', '数学类');
-- ----------------------------
